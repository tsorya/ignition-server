...
// WithClusterID adds the clusterID to the get config params
func (o *GetConfigParams) WithClusterID(clusterID string) *GetConfigParams {
	o.SetClusterID(clusterID)
	return o
}

// SetClusterID adds the clusterId to the get config params
func (o *GetConfigParams) SetClusterID(clusterID string) {
	o.ClusterID = clusterID
}

// WithRole adds the role to the get config params
func (o *GetConfigParams) WithRole(role string) *GetConfigParams {
	o.SetRole(role)
	return o
}

// SetRole adds the role to the get config params
func (o *GetConfigParams) SetRole(role string) {
	o.Role = role
}

...
type GetConfigOK struct {
	Payload *models.ConfigParams
}

func (o *GetConfigOK) Error() string {
	return fmt.Sprintf("[GET /config/{clusterId}/{role}][%d] getConfigOK  %+v", 200, o.Payload)
}

func (o *GetConfigOK) GetPayload() *models.ConfigParams {
	return o.Payload
}

func (o *GetConfigOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ConfigParams)
